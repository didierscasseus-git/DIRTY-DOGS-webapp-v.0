export const menuData = {
    food: [
        ...
        { id: 't1', name: 'Tacos de Mama', price: 21, description: '3 Tacos. 6-hour slow-cooked pulled beef, homemade pico de gallo, pickled onions, mama’s secret garlic sauce. Served on fresh local artisan corn tortillas.', category: 'Dirty Tacos (3 for $21)', image: '/assets/tacos-plate.webp' },
        { id: 't2', name: 'Mango Shrimp Tacos', price: 21, description: '3 Tacos. Shrimp marinated in fresh mango salsa, homemade pico de gallo, pickled onions, mama’s secret garlic sauce. Served on fresh local artisan corn tortillas.', category: 'Dirty Tacos (3 for $21)', image: '/assets/tacos-plate.webp' },
        { id: 't3', name: 'Tacos Carnitas', price: 21, description: '3 Tacos. 8-hour slow-cooked pulled pork, homemade pico de gallo, pickled onions, tangy jalapeno salsa. Served on fresh local artisan corn tortillas.', category: 'Dirty Tacos (3 for $21)', image: '/assets/tacos-plate.webp' },

        // Dirty Grinottes (Appetizers)
        { id: 'a1', name: 'Chips n Guac', price: 13, description: 'Crispy corn tortilla chips, guacamole, homemade pico de gallo.', category: 'Dirty Grinottes (Appetizers)', image: '/assets/plate2.webp' },
        ...
        { id: 'b1', name: 'La Burrata', price: 29, description: '5oz piece of burrata, BBQ sauce, cheddar, caramelized onions, pesto. Smashed with two patties and served with fresh fries.', category: 'Dirty Burger & Dogs', image: '/assets/buratta.webp' },
        ...
        { id: 'p1', name: 'La Burrata', price: 28, combo_price: 22.50, description: '5oz piece of burrata, BBQ sauce, cheddar, caramelized onions, pesto. Made with fresh fries, cheese curds, and gravy.', category: 'Dirty Poutines', image: '/assets/plate2.webp' },
        ...
        { id: 'p5', name: 'Le Hulk', price: 21.50, combo_price: 14, description: 'Cheddar, bacon, avocado, fried egg, and DD secret sauce. Made with fresh fries, cheese curds, and gravy.', category: 'Dirty Poutines', image: '/assets/hulkpoutine.webp' },
